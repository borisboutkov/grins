...
namespace GRINS
{
  ...
  template<class Mu>
  ParsedVelocitySourceAdjointStabilization<Mu>::~ParsedVelocitySourceAdjointStabilization()
  {
    return;
  }

  template<class Mu>
  void ParsedVelocitySourceAdjointStabilization<Mu>::init_context( AssemblyContext& context )
  {
                                                                     ...
                                                                     CachedValues& /*cache*/ )
  {
    ...
    this->_timer->BeginTimer("ParsedVelocitySourceAdjointStabilization::element_time_derivative");
#endif
  ...
  {
#ifdef GRINS_USE_GRVY_TIMERS
    this->_timer->BeginTimer("ParsedVelocitySourceAdjointStabilization::element_constraint");
#endif
...
#ifdef GRINS_USE_GRVY_TIMERS
    this->_timer->EndTimer("ParsedVelocitySourceAdjointStabilization::element_constraint");
#endif
